...
public class FirstPersonPlayerController : MonoBehaviour {
    ...
    //private void CheckForWeaponInputs() {
    //    if (Input.GetButtonDown("Fire1") && !carryManager.ItemIsBeingCarried) {
    //        toolManager.PerformPrimaryAction();
    //    } else if (Input.GetButtonDown("Fire2") && !carryManager.ItemIsBeingCarried) {
    //        toolManager.PerformSecondaryAction();
    //    }
    //}
